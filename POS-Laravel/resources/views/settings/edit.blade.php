...
<div class="card">
    <div class="card-body">
        <form action="{{ route('settings.store') }}" method="post">
            ...
            <div class="form-group">
                <label for="warning_quantity">Kuantitas Peringatan</label>
            ...
            <button type="submit" class="btn btn-success btn-block btn-lg"><i class="fas fa-check"></i> Kirim Perubahan</button>
        </form>
    </div>
</div>
@endsection
